...
@Composable
fun ReplyHomeScreen(
    navigationType: ReplyNavigationType, // NUEVO parámetro
    ...
    // Si la pantalla es Expanded Y estamos en la home, usa panel lateral permanente
    if (navigationType == ReplyNavigationType.PERMANENT_NAVIGATION_DRAWER
        ...
        // Compact y Medium: mismo flujo if/else de antes
