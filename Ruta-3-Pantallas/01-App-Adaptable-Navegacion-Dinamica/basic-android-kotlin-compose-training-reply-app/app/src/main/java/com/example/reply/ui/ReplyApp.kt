...
@Composable
fun ReplyApp(
    windowSize: WindowWidthSizeClass, // NUEVO parámetro
    modifier: Modifier = Modifier
) {
    val viewModel: ReplyViewModel = viewModel()
    val replyUiState = viewModel.uiState.collectAsState().value

    // Elige el tipo de navegación según el ancho real de pantalla,
    // no según el tipo de dispositivo
    ...
    ReplyHomeScreen(
        navigationType = navigationType, // NUEVO
